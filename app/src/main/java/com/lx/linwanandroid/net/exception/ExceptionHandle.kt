package com.lx.linwanandroid.net.exception
...
class ExceptionHandle {
    companion object {
        ...
        var errorCode = ApiStatus.UNKNOWN_ERROR
        ...
        fun handleException(e: Throwable): String {
            ...
            if (e is SocketTimeoutException
                ...
                errorMsg = "网络连接异常"
                errorCode = ApiStatus.NETWORK_ERROR
                ...
                errorMsg = "数据解析异常"
                errorCode = ApiStatus.SERVER_ERROR
                ...
                errorCode = ApiStatus.UNKNOWN_ERROR
            }
            return errorMsg
        }

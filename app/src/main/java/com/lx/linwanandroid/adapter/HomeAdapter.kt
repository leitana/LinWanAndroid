 ...
 */
class HomeAdapter(val mContext: Context?, datas: MutableList<HomeArticle.DatasBean>)
    : BaseQuickAdapter<HomeArticle.DatasBean, BaseViewHolder>(R.layout.item_home_list, datas),
    LoadMoreModule {

    override fun convert(helper: BaseViewHolder, item: HomeArticle.DatasBean) {
